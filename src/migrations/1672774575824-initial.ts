...
export class initial1672774575824 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "tokenId" character varying NOT NULL, "exp" TIMESTAMP NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "replies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "message" character varying NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "modified" TIMESTAMP NOT NULL DEFAULT now(), "contactId" uuid, CONSTRAINT "PK_08f619ebe431e27e9d206bea132" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contact_us" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "from" character varying NOT NULL, "name" character varying NOT NULL, "message" character varying NOT NULL, "subject" character varying NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b61766a4d93470109266b976cfe" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_service" ("userId" uuid NOT NULL, "serviceId" uuid NOT NULL, CONSTRAINT "PK_99763ce5b20091eb088378b2643" PRIMARY KEY ("userId", "serviceId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0d89f5c3ebb7ad2210fe481ca2" ON "user_service" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_cd591dd96158424a40461f26e7" ON "user_service" ("serviceId") `);
        ...
        await queryRunner.query(`ALTER TABLE "replies" ADD CONSTRAINT "FK_3667c0cf1d8bbf0ff5733fc572b" FOREIGN KEY ("contactId") REFERENCES "contact_us"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user_service" ADD CONSTRAINT "FK_0d89f5c3ebb7ad2210fe481ca20" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "user_service" ADD CONSTRAINT "FK_cd591dd96158424a40461f26e74" FOREIGN KEY ("serviceId") REFERENCES "services"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_service" DROP CONSTRAINT "FK_cd591dd96158424a40461f26e74"`);
        await queryRunner.query(`ALTER TABLE "user_service" DROP CONSTRAINT "FK_0d89f5c3ebb7ad2210fe481ca20"`);
        ...
        await queryRunner.query(`ALTER TABLE "replies" DROP CONSTRAINT "FK_3667c0cf1d8bbf0ff5733fc572b"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_cd591dd96158424a40461f26e7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0d89f5c3ebb7ad2210fe481ca2"`);
